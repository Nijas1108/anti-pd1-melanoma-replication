#!/bin/bash
#SBATCH --job-name=fastp_trim_ucla
...
INPUT_DIR="/rds/projects/e/elhamsak-group5/main_project/UCLA_samples"
OUT_DIR="/rds/projects/e/elhamsak-group5/main_project/trimmed_files/UCLA_samples"
