#!/bin/bash
#SBATCH --job-name=mutect2_refined
...
BED="/rds/projects/e/elhamsak-group5/main_project/reference_genome/twist_exome_bed/Twist_Exome_Core_hg38_padded.bed"

# UCLA
#ALIGN_DIR="/rds/projects/e/elhamsak-group5/main_project/processed_data/aligned_files/UCLA_samples/processed_bams"
#OUT_BASE="/rds/projects/e/elhamsak-group5/main_project/processed_data/wes/variant_calling/ucla_processed_bed"

# Vanderbilt
ALIGN_DIR="/rds/projects/e/elhamsak-group5/main_project/processed_data/aligned_files/vanderbilt_samples/processed_bams"
OUT_DIR="/rds/projects/e/elhamsak-group5/main_project/processed_data/wes/variant_calling/vanderbilt_processed_bed"
...
# check for sample contamination and tumour-normal contamination
