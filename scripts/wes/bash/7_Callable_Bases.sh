...
TARGET_BED="/rds/projects/e/elhamsak-group5/main_project/reference_genome/twist_exome_bed/Twist_Exome_Core_hg38_padded.bed"
OUT_DIR="/rds/projects/e/elhamsak-group5/main_project/results/wes/coverage_results"
mkdir -p "$OUT_DIR" logs

# 4. Find BAM Paths
UCLA_PATH="/rds/projects/e/elhamsak-group5/main_project/processed_data/aligned_files/UCLA_samples/processed_bams"
VAND_PATH="/rds/projects/e/elhamsak-group5/main_project/processed_data/aligned_files/vanderbilt_samples/processed_bams"
...
# 5. Run Mosdepth / -t means 4 threads
...
# run in terminal after the job is complete: 
